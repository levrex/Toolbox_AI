...
PROJECTION_DATA = 'all_data_MMAE_clustering_260_NEW' # all_data_MAUI_clustering_240_NEW
...
col_1 = 'PhenoGraph_iter_0'
col_2 = 'PhenoGraph_iter_' + str(999) 
...
func.visualize_umap_bokeh_na_2(fit1, metadata[l_final_col], list(l_final_col), l_binary=l_cat, patient_id='sample', cluster_id='PhenoGraph_clusters', title='MMAE_PHENOGRAPH_260_STABILITY_TSNE')
func.visualize_umap_bokeh_na_2(fit2, metadata[l_final_col], list(l_final_col), l_binary=l_cat, patient_id='sample', cluster_id='PhenoGraph_clusters', title='MMAE_PHENOGRAPH_260_STABILITY_UMAP')
